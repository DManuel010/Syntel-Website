...
public class SuperAdmin extends Admin {
	...
	public void addEmployees(Connection conn){
		...
		System.out.println("Enter hire date (dd-MMM-yy): ");
		...
		case "admin": employee = new Admin(email, firstName, lastName, login.getLoginID(), 
				phone, home.getLocationID(), "28-MAY-18", 0, hireDate, title, workAddrID);
		case "Admin": employee = new Admin(email, firstName, lastName, login.getLoginID(), 
				phone, home.getLocationID(), "28-MAY-18", 0, hireDate, title, workAddrID);
	...
	public void removeEmployees(Connection conn){
		EmployeeService employeeService = new EmployeeService(conn);
		viewEmployees(conn);
	...
	public void editEmployees(Connection conn){
		...
		case 1: editFirstName(empID, conn);
		break;
			
		case 2: editLastName(empID, conn);
		break;
		
		case 3: editTitle(empID, conn);
		break;
		
		case 4: editEmail(empID, conn);
		break;
		
		case 5: editPhoneNumber(empID, conn);
		break;
		
		case 6: editWorkAddressID(empID, conn);
		break;
		
		case 7: editAddress(empID, conn);
		break;
	...
	public void editFirstName(int empID, Connection conn){
	...
	public void editLastName(int empID, Connection conn){
	...
	public void editAddress(int empID, Connection conn){
	...
	public void editWorkAddressID(int empID, Connection conn){
	...
	public void editPhoneNumber(int empID, Connection conn){
	...
	public void editEmail(int empID, Connection conn){
	...
	public void editTitle(int empID, Connection conn){
